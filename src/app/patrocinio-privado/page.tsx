      ...
      <div className="sponsor-container">
        ...
        <div className="packages">
          <div className="package">
            <div className="package-header">
              ...
              <div className="package-price">$150,000 MXN</div>
            </div>
          ...
          <div className="package">
            <div className="package-header">
              <div className="package-title">💎 GOLD</div>
              <div className="package-price">$80,000 MXN</div>
            </div>
            <ul className="benefits-list">
          ...
          <div className="package">
            <div className="package-header">
              ...
              <div className="package-price">$40,000 MXN</div>
            </div>
            <ul className="benefits-list">
          ...
          <div className="package">
            <div className="package-header">
              ...
              <div className="package-price">$20,000 MXN</div>
            </div>
            <ul className="benefits-list">
              <li>Logo PEQUEÑO en escenario</li>
              <li>Mesa de información</li>
              <li>Logo en sitio web</li>
              <li>Redes sociales (3 posts)</li>
              <li>Logo en material impreso</li>
              <li>2 pases de acceso completo</li>
            </ul>
          </div>
        </div>
        ...
        <table className="detail-table">
          ...
          <tbody>
            ...
            <tr>
              <td>Logo GRANDE (Gold)</td>
              <td>2m x 1.5m</td>
              <td>Posición lateral destacada</td>
              <td>$20,000 MXN</td>
            </tr>
            <tr>
              <td>Logo MEDIANO (Silver)</td>
              <td>1.5m x 1m</td>
              <td>Panel lateral</td>
              <td>$10,000 MXN</td>
            </tr>
            <tr>
              <td>Logo PEQUEÑO (Bronze)</td>
              <td>1m x 0.7m</td>
              <td>Banner rotativo</td>
              <td>$5,000 MXN</td>
            </tr>
          </tbody>
        </table>
        ...
        <table className="detail-table">
          ...
          <tbody>
            ...
            <tr>
              <td>Mesa de Información</td>
              <td>1.5m x 0.8m</td>
              <td>Mesa y sillas básicas</td>
              <td>$5,000 MXN</td>
            </tr>
          </tbody>
        </table>
        ...
        <table className="detail-table">
          ...
          <tbody>
            ...
            <tr>
              <td>Redes Sociales (3 posts)</td>
              <td>Instagram, Twitter, LinkedIn, Facebook</td>
              <td>12,000+ impresiones</td>
              <td>$3,000 MXN</td>
            </tr>
            <tr>
        ...
        <div className="info-box">
          ...
          <p><strong>Inversión total en marketing:</strong> $200,000+ MXN | <strong>Alcance proyectado:</strong> 100,000+ personas</p>
        </div>
